  ...
  return (
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full h-screen bg-white-200 relative">
        ...
        <div className="w-full h-xl flex justify-center items-center gap-10 p-4 ">
          <span className="font-blod w-full text-black">enter name for delete goal</span>
          <span className="font-bold w-full">enter name : <input type="text" name="goal name" id="goal name" className="rounded-xl text-black w-full" onChange={(e) => {setgoalname(e.target.value)}} value={goalname}/> </span>
