    ...
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full h-screen bg-white-200 relative">
        ...
        <div className="w-full bg-white h-full relative gap-5 p-5 overflow-auto">
          <div className='w-full h-40 relative flex justify-center items-center rounded-xl'>
          ...
          <div className='w-full bg-gray-600 h-screen relative'>
            <div className="w-full justify-center items-center h-10 p-3 gap-5 bg-slate-400 flex">
              <h1>
                asd
              </h1>
              <h1>
