    ...
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full h-screen bg-white-200 relative">
        ...
        <div className="w-full bg-white h-full relative gap-5 p-5 overflow-auto">
          <div className='w-full bg-gray-700 h-32 relative flex overflow-auto justify-center items-center'>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">asd</h1>
          </div>
          <div className='w-full bg-gray-600 h-full relative flex overflow-auto'>
