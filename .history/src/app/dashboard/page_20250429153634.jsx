  ...
  return (
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full h-screen bg-white-200 relative">
        ...
        <div className="w-full bg-white h-full relative gap-5 p-5 overflow-auto">
          <div className='w-full h-40 relative flex justify-center items-center rounded-xl gap-10'>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
              your goal
            </h1>
          </div>
          <div className='w-full h-10 relative flex justify-center items-center rounded-xl gap-10'>
          ...
          <div className='w-full bg-gray-600 h-screen relative'>
            
            {Object.entries(priceandgoalname).map(([key, value]) => (
            <div key={key} className="w-full justify-center items-center h-10 p-3 gap-5 bg-slate-400 flex">
              <h1 className='text-2xl font-bold bg-gradient-to-r  text-transparent bg-clip-text'>
                {key}
              </h1>
              <h1>
                {value}
