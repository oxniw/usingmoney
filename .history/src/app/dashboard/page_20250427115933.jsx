...
function page() {
  ...
  return (
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full bg-white-200 h-full relative gap-5 p-5 flex overflow-auto">
        {Object.entries(priceandgoalname).map(([key, value]) => {<div>
