...
function opoup({ onClose }) {
  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center z-50 shadow-lg bg-gradient-to-r bg-opacity-10 backdrop-blur-lg transition-all duration-300 fadein gap-5 ${fadeOut ? "opacity-0" : "opacity-100"} `}>
