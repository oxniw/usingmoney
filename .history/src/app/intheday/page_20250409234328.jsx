      ...
      <div className="w-full bg-white-200 h-full relative grid grid-rows-3 gap-5 p-5">
        ...
        <div className="w-full gap-2 flex max-w-52 p-5 relative">
          <div className="w-full flex bg-slate-500 justify-top items-top rounded-xl">
            <h1 className="drop-shadow-[0_0_2px_black] text-2xl font-bold bg-white-100 text-transparent bg-clip-text gap-12 p-12">totalincome {totalincome}</h1>
          </div>
          <div className="w-full flex bg-slate-500 justify-top items-top rounded-xl">
            <h1 className="drop-shadow-[0_0_2px_black] text-2xl font-bold bg-white-100 from-red-500 via-purple-500 to-blue-500 text-transparent bg-clip-text gap-12">totalexpense {totalexpense}</h1>
          </div>
          <div className="w-full flex bg-slate-500 justify-top items-top rounded-xl">
            <h1 className="drop-shadow-[0_0_2px_black] text-2xl font-bold bg-white-100 from-cyan-500 to-blue-500 text-transparent bg-clip-text gap-12">balance {totalincome - totalexpense}</h1>
          </div>
