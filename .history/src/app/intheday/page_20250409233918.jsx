    ...
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full bg-white-200 h-full relative grid grid-rows-3 gap-5 p-5">
        ...
        <div className="w-full gap-2 flex max-w-52 p-5 relative">
          <div className="w-full flex bg-slate-500 justify-center items-center rounded-xl max-h-24">
            <h1 className="drop-shadow-[0_0_2px_black] text-xl font-bold bg-white-100 text-transparent bg-clip-text">totalincome {totalincome}</h1>
          </div>
          <div className="w-full flex bg-slate-500 justify-center items-center rounded-xl max-h-24">
