...
function page() {
  ...
  return (
    <div className="relative h-screen bg-black">
      ...
      <div className=" justify-center items-center flex w-full text-4xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text gap-6">
              Barchart and pie charts
          </div>
        <div className="w-full gap-2 flex">
        
        
        <div className="w-full gap-2 flex overflow-x-auto bg-white rounded-xl transition-transform duration-300 hover:scale-105">
