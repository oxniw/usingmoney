...
function page() {
  ...
  return (
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full bg-white-200 h-full relative gap-5 p-2 flex">{Object.entries(datas).map(([key, value]) => (
            <div key={key} className="w-full max-w-24 bg-slate-500 rounded-xl p-5">
              <h3>{key}</h3>
              <ul>
                {value.map((item, idx) => (
