    ...
    <div className="relative h-screen bg-black">
      ...
      <div className="w-full bg-white-200 h-full relative gap-5 p-5 flex">{Object.entries(datas).map(([key, value]) => (
            <div key={key} className="">
              <h3 className="drop-shadow-[0_0_2px_black] text-2xl font-bold bg-white-100 from-cyan-500 to-blue-500 text-transparent bg-clip-text gap-12 p-2">{}{key.split(",")[0]}</h3>
              <ul>
                {value.map((item, idx) => (
